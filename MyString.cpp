//code by Angel Dimitriev: https://github.com/Angeld55/Object-oriented_programming_FMI/blob/master/Week%2009/MyString%20(with%20move)/MyString.cpp
//changes made - removed Bulgarian-language comments
...
char& MyString::operator[](size_t index) //non-const access
{
	return _data[index];
}

char MyString::operator[](size_t index) const //const access
{
	return _data[index];
}
